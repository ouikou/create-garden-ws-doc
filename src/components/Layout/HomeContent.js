      ...
      <div className="ps-0">
        ...
        <Section background="left-card">
          <Center>
            ...
            <Para>
              GARDEN ScenarioPlatform
              はシナリオベースの開発プロセスをサポートするオープンソースツールのセットです。
            </Para>
          </Center>
          <FullBleed>
            <MDXComponents.YouTubeIframe src="https://www.youtube.com/embed/LEAiHJPXjrM" />
          </FullBleed>
          <Center>
            <div className="flex justify-start w-full lg:justify-center">
              <CTA color="gray" icon="code" href="#">
                Learn how to use GARDEN
              </CTA>
            </div>
          </Center>
        </Section>
